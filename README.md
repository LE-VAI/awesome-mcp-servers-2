...
- <img src="https://www.designesy.org/favicon.ico" height="14" /> [Designesy](https://github.com/LE-VAI/designesy-org) - Score any URL against a 40-check design-system contract — tokens, motion, accessibility, cadence, typography, copywriting. A–F grade, DTCG 2025.10 token validation, Lottie motion validation. Ships a GitHub Action with SARIF v2.1.0 output + baseline ratchet for CI design regression prevention.
